...
<head>
    ...
    <link rel="stylesheet" href="css/hoa quả tươi.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    ...
                    <p style="color:rgb(24, 84, 59);font-weight: bold;">Size</p>
                    <p style="color:rgb(24, 84, 59);font-weight: bold;">Số lượng sản phẩm</p>
                </div>
                <div class="col-9">
                    <img src="media/anh48.jpg" height="333px"width="120%">
                </div>
            </div>
        </div>
</div>
...
$model = new ttsp();
$sl = $model->select_danhmuc("TRÁI CÂY TƯƠI");
$count = 0;
?>
<div style="background-color: mintcream;">
<div class="container" style="background-color: mintcream;">
    <div class="row"> <!-- Mở hàng đầu tiên -->
        <?php foreach ($sl as $row) { 
            $count++; 
        ?>
            <div class="col-md-3 mb-4"> <!-- Mỗi sản phẩm chiếm 3 cột -->
                <div class="card image-zoom" style="width:280px; height: 450px;">
                    <a href="chitietsp.php?id=<?php echo $row['id']; ?>"><img class="card-img-top" src="../upload/<?php echo $row['hinhanh']; ?>" alt="Hình ảnh sản phẩm"></a>
                    <div class="card-body" style="margin-top: -10px;">
                        <p class="card-text text-uppercase font-weight-bold text-center" style="font-weight: 600; text-transform: uppercase; text-align: center;min-height: 50px; ">
                            <?php echo $row['tensp']; ?>
                        </p>
                        <p class="text-center text-danger font-weight-bold" style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;">
                            <?php echo number_format($row['gia'], 0, ',', '.'); ?>₫
                        </p>
                        <a href="chitietsp.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-success d-block mx-auto">Xem thêm</a>
            ...
            <?php if ($count % 4 == 0) { ?>
                </div><div class="row mt-3"> <!-- Đóng hàng cũ và mở hàng mới -->
            <?php } ?>
        <?php } ?>
    ...
    <div class="nen">
        <div class="reviews">
          <!-- Review 1 -->
          <div class="review">
            <img src="media/anh10.png" alt="Ảnh 1" class="review-image">
            <div class="stars">
              ★ ★ ★ ★ ☆
            </div>
          ...
          <!-- Review 2 -->
          <div class="review">
            <img src="media/anh11.png" alt="Ảnh 2" class="review-image">
            <div class="stars">
              ★ ★ ★ ★ ★
            </div>
            <p class="review-text">Giỏ Quà Trái Cây Nho Nhập Khẩu & Hoa...</p>
            <p class="reviewer">Bạn Thủy</p>
          </div>
      
          <!-- Review 3 -->
          <div class="review">
            <img src="media/anh16.jpg" alt="Ảnh 3" class="review-image">
            <div class="stars">
              ★ ★ ★ ★ ☆
            </div>
            <p class="review-text"> Mẫu sang trọng,nhìn sang , đẹp mắt</p>
            <p class="reviewer">Minh Đạt</p>
          </div>
      
          <!-- Review 4 -->
          <div class="review">
            <img src="media/anh18.jpg" alt="Ảnh 4" class="review-image">
            <div class="stars">
              ★ ★ ★ ★ ★
            </div>
            <p class="review-text">Vitamin House - Giỏ quà trái cây, cam nho...</p>
            <p class="reviewer">Thanh Tùng</p>
          </div>
      
          <!-- Review 5 -->
          <div class="review">
            <img src="media/anh17.jpg" alt="Ảnh 5" class="review-image">
            <div class="stars">
              ★ ★ ★ ★ ★
            </div>
            <p class="review-text">Trái Cây Nhập Khẩu Nhỏ - Nho, Táo....Ngon,đẹp...</p>
            <p class="reviewer">Anh Tuấn</p>
          </div>
        </div>
      </div>
