...
if($sl->num_rows == 0){
    echo "<h2 style='text-align: center; color: black;'>Không tìm thấy sản phẩm nào!</h2>";
}   
?>
        ...
        ?>
            <div class="col-md-3 mb-4"> <!-- Mỗi sản phẩm chiếm 3 cột -->
                <div class="card image-zoom" style="width:280px; height: 450px;">
                    <a href="#"><img class="card-img-top" src="../upload/<?php echo $row['hinhanh']; ?>" alt="Hình ảnh sản phẩm"></a>
