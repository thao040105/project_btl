...
<head>
    ...
    <link rel="stylesheet" href="css/tết cổ tryền.css">
    ...
    <div style="background-color: mintcream;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-9">
                    <img src="media/anh101.jpg" height="405px"width="105%">
                </div>
            </div>
        </div>
        <?php
        ...
        $model = new ttsp();
        $sl = $model->select_danhmuc("TẾT CỔ TRUYỀN");
        $count = 0;
    ?>
<div style="background-color: mintcream;padding: 30px;">
