...
?>
    <div style="background-color: mintcream;">
       <div class="container" >
       <form method="post" action="../Control/dangky.php" class="registration-form">
            ...
            <div class="mb-3">
                <label for="confirm-password" class="form-label text-success">Nhập lại mật khẩu:</label>
                <input type="password" id="confirm-password" name="txtrepass" class="form-control" required>
            <div class="text-center">
                <button type="submit" name="sub_dk" class="btn btn-success">Đăng Ký</button>
            </div>
        </form>
