    ...
    <div style="background-color: mintcream;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-9">
                    <img src="media/anh98.jpg" height="333px"width="120%">
                </div>
            </div>
        </div>
        ...
        <div class="container" style="margin-top: 20px; background-color: mintcream;">
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh98.jpg"> </a>
                    <div class="card-body">
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh99.png"> </a>
                    <div class="card-body">
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh100.png"> </a>
                    <div class="card-body">
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh101.jpg"> </a>
                    <div class="card-body">
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh102.png"> </a>
                    <div class="card-body">
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh103.jpg"> </a>
                    <div class="card-body">
        ...
        <div class="container" style="margin-top: 20px; background-color: mintcream;">
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh104.jpg"> </a>
                    <div class="card-body">
                      <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Bánh Cuộn June 1st ĐL Hộp 256g</p>
                      <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                      <button type="button" class="btn btn-outline-success" style="margin-left: 45px;">Xem thêm</button>
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh105.jpg"> </a>
                    <div class="card-body">
                      <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Bánh Trung Thu Duen Tai Đài Loan Hộp 6 Cái</p>
                      <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                      <button type="button" class="btn btn-outline-success" style="margin-left: 45px;">Xem thêm</button>
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh106.jpg"> </a>
                    <div class="card-body">
                    <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Hộp Bánh Bông Lan Tươi Imei ĐL 400gr</p>
                    <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                    <button type="button" class="btn btn-outline-success" style="margin-left: 45px;">Xem thêm</button>
            ...
            <div class="col-2">
                <div class="card image-zoom" style="width:220px; height: 390px;">
                    <a href="#"><img class="card-img-top" src="media/anh107.jpg"> </a>
                    <div class="card-body">
                    <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;  ">Bánh Hành Kẹp Sữa Bò ChiaTe Đài Loan </p>
                    <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 475.000₫</p>
                    <button type="button" class="btn btn-outline-success" style="margin-left: 45px;">Xem thêm</button>
