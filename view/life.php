...
?>
    <div style="background-color: mintcream;">
        <div class="container">
            <div class="row">
                <div class="col-3">
                    ...
                    <ul>
                        <li style="list-style-type: none;"><input type="checkbox">GIẤY (3)</li>
                        <li style="list-style-type: none;"><input type="checkbox"> LIFE STYLE (5)</li>
                    </ul>
                    <p style="color:rgb(24, 84, 59);font-weight: bold;">Brand</p>
                    <ul>
                        <li style="list-style-type: none;"><input type="checkbox"> DURIA (1)</li>
                        <li style="list-style-type: none;"><input type="checkbox"> ELLO (1)</li>
                    </ul>
                    <p style="color:rgb(24, 84, 59);font-weight: bold;">Màu</p>
                    <Ul>
                        <li style="list-style-type: none;"><input type="checkbox">Khăn vải trắng (1)</li>
                        <li style="list-style-type: none;"><input type="checkbox">Khăn vải xanh (1)</li>
                    </Ul>
                    <p style="color:rgb(24, 84, 59);font-weight: bold;">Vị</p>
                    <ul>
                        <li style="list-style-type: none;"><input type="checkbox"> Bào Ngư (1)</li>
                        <li style="list-style-type: none;"><input type="checkbox">Cua Bat Bửu (1)</li>
                    </ul>
                </div>
                <div class="col-9">
                    <img src="media/anh69.jpg" height="333px"width="120%">
                </div>
            </div>
        </div>
        <div class="container-fluid" style="background-color: mintcream;">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh70.png"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            ...
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh71.png"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh72.png"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh73.png"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
        ...
        <div class="container-fluid"  style="background-color: mintcream;">
            <div class="row">
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh74.png"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh75.png"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh76.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh77.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
        ...
        <div class="container-fluid"  style="background-color: mintcream;">
            <div class="row">
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh78.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh79.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh80.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh81.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
        ...
        <div class="container-fluid"  style="background-color: mintcream;">
            <div class="row">
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh82.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh83.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
                ...
                <div class="col-2">
                    <div class="card image-zoom" style="width:280px; height: 450px;">
                        <a href="#"><img class="card-img-top" src="media/anh84.jpg"> </a>
                        <div class="card-body" style="margin-top: -10px;">
                            <p class="card-text" style="font-weight: 600; text-transform: uppercase; text-align: center;">Việt Quất Rainier Organic Mỹ Hộp 125g</p>
                            <p style="text-align: center; color: red; font-weight: 600; margin-top: -10px; font-size: 20px;"> 640.000₫</p>
                            <button type="button" class="btn btn-outline-success" style="margin-left: 75px;">Xem thêm</button>
    ...
    <p style="color:rgb(236, 236, 13); text-align: center;">★ ★ ★ ★ ★</p>
    ...
    <P style="color:rgb(24, 84, 59); padding:30px; font-size: 25px; "> Recently viewed</P>
