            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <ul>
                        ...
                        <li style="list-style-type: none;"><input type="checkbox">KẸO BÔNG GÒN (6)</li>
                        <li style="list-style-type: none;"><input type="checkbox"> KẸO NỔ (1)</li>
                    </ul>
                ...
                <div class="col-9">
                    <img src="media/anh86.jpg" height="333px"width="120%">
                </div>
            </div>
        </div>
    <?php
